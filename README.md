<div align="center">
  <h1>JanSaathi ðŸ‡®ðŸ‡³</h1>
  <p><strong>Agentic AI Legal &amp; Civic Reasoning Engine for Indian Citizens</strong></p>
  <p>Built with LangGraph Â· Hybrid RAG Â· NetworkX Knowledge Graphs Â· Custom 19-Class InLegalBERT Classifier Â· Reflexion Self-Correction</p>
</div>

> **Quick Links:**
> [Setup &amp; Run](#running-locally) Â· [Architecture](#state-graph-langgraph-pipeline) Â· [Technical Deep-Dive](#technical-deep-dive) Â· [Repo Structure](#repository-structure)
