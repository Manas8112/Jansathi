...
def detect_language(text: str) -> str:
    ...
    hinglish_words = {
        ...
        "karo", "karta", "karti", "karte", "kiya", "kiye",
        ...
        "kaam", "pata", "matlab", "mila", "baat", "cheez",
...
def get_language_instruction(lang_code: str) -> str:
    ...
    if lang_code == "hi":
        return (
            "IMPORTANT: The user is writing in Hindi. You MUST reply entirely in Hindi "
            "(Devanagari script). Use simple, clear Hindi that a common citizen can understand. "
            "Legal terms can stay in English."
        )
    elif lang_code == "hinglish":
        return (
            "IMPORTANT: The user is writing in Hinglish (Hindi-English mix). You MUST reply in "
            "Hinglish — use simple Hindi words mixed with English for legal terms. "
